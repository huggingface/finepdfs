...
from docling_core.types.doc.base import CoordOrigin, ImageRefMode, BoundingBox, Size
...
class PageNumberItem(TextItem):
    """PageNumberItem."""
    
    label: typing.Literal[DocItemLabel.PAGE_NUMBER] = (
        DocItemLabel.PAGE_NUMBER  # type: ignore[assignment]
    )
